...
html{height:100%;background:#0f0c29;}  
body{  
  margin:0;  
  min-height:100%;  
...
button{touch-action:manipulation;-webkit-tap-highlight-color:transparent;cursor:pointer;-webkit-touch-callout:none;}  
</style>    
</head>    
<body>    
<div id="app">    
...
<div id="reset-btn-wrap" style="display:none;position:fixed;bottom:max(24px,env(safe-area-inset-bottom,24px));left:50%;transform:translateX(-50%);z-index:20;padding-bottom:env(safe-area-inset-bottom,0px)">    
<button id="reset-btn"    
